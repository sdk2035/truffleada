...
package body Sem_Cat is
   ...
   --  Determines if current scope is within a Remote Call Interface
   --  compilation unit, for semantic checking purposes only (returns false
   --  within an instance and within the package body).
   ...
   begin
      ...
      if not In_RCI_Declaration then
         return;
      end if;
   ...
   begin
      ...
      if not Comes_From_Source (T)
        or else (not In_RCI_Declaration
