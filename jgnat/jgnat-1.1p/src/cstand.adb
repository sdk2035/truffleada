...
package body CStand is
   ...
   begin
      ...
      Init_Alignment    (Standard_Boolean);
      ...
      Init_RM_Size   (Standard_Character, Standard_Character_Size);
      Init_Alignment (Standard_Character);
      ...
      Init_Esize     (Standard_Wide_Character, Standard_Wide_Character_Size);
      Init_RM_Size   (Standard_Wide_Character, Standard_Wide_Character_Size);
      Init_Alignment (Standard_Wide_Character);
      ...
      Init_Esize         (Standard_String);
      Init_Alignment     (Standard_String);
      ...
      Init_Esize         (Standard_Wide_String);
      Init_Alignment     (Standard_Wide_String);
      ...
      Init_Alignment     (Standard_Natural);
      ...
      Init_Alignment     (Standard_Positive);
      ...
      Init_Esize     (Standard_Void_Type);
      Init_Alignment (Standard_Void_Type);
      ...
      if Debug_Flag_6 then
         Init_Esize  (Standard_A_String, System_Address_Size);
      else
         Init_Esize  (Standard_A_String, System_Address_Size * 2);
      end if;
      ...
      Init_Esize     (Standard_A_Char, System_Address_Size);
      Init_Alignment (Standard_A_Char);
      ...
      Init_Esize            (Any_Access, System_Address_Size);
      Init_Alignment        (Any_Access);
      ...
      Init_Esize            (Any_Array);
      Init_Alignment        (Any_Array);
      ...
      Init_Esize            (Any_Boolean, 1);
      Init_RM_Size          (Any_Boolean, 1);
      Init_Alignment        (Any_Boolean);
      ...
      Init_RM_Size          (Any_Character, Standard_Character_Size);
      Init_Alignment        (Any_Character);
      ...
      Init_Esize            (Any_Composite);
      Init_Alignment        (Any_Composite);
      ...
      Init_Esize            (Any_Discrete, Standard_Integer_Size);
      Init_RM_Size          (Any_Discrete, Standard_Integer_Size);
      Init_Alignment        (Any_Discrete);
      ...
      Init_Esize            (Any_Fixed, Standard_Integer_Size);
      Init_RM_Size          (Any_Fixed, Standard_Integer_Size);
      Init_Alignment        (Any_Fixed);
      ...
      Init_Esize            (Any_Integer, Standard_Long_Long_Integer_Size);
      Init_RM_Size          (Any_Integer, Standard_Long_Long_Integer_Size);
      Init_Alignment        (Any_Integer);
      ...
      Init_Esize            (Any_Modular, Standard_Long_Long_Integer_Size);
      Init_RM_Size          (Any_Modular, Standard_Long_Long_Integer_Size);
      Init_Alignment        (Any_Modular);
      ...
      Init_Esize            (Any_Numeric, Standard_Long_Long_Integer_Size);
      Init_RM_Size          (Any_Numeric, Standard_Long_Long_Integer_Size);
      Init_Alignment        (Any_Numeric);
      ...
      Init_Esize            (Any_Real, Standard_Long_Long_Float_Size);
      Init_Alignment        (Any_Real);
      ...
      Init_Esize            (Any_Scalar, Standard_Integer_Size);
      Init_RM_Size          (Any_Scalar, Standard_Integer_Size);
      Init_Alignment        (Any_Scalar);
      ...
      Init_Esize            (Any_String);
      Init_Alignment        (Any_String);
      ...
      Init_Esize     (Universal_Fixed, Standard_Long_Long_Integer_Size);
      Init_RM_Size   (Universal_Fixed, Standard_Long_Long_Integer_Size);
      Init_Alignment (Universal_Fixed);
      Set_Size_Known_At_Compile_Time
                     (Universal_Fixed);
      ...
      begin
         ...
         Init_Esize       (Standard_Duration, 64);
         Init_RM_Size     (Standard_Duration, 64);
         Init_Alignment   (Standard_Duration);
      ...
      Init_Esize     (Standard_Exception_Type);
      Init_Alignment (Standard_Exception_Type);
      Set_Size_Known_At_Compile_Time
