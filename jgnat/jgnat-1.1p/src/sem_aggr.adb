...
package body Sem_Aggr is
   ...
   --  ??? THIS IS TEMPORARY STUFF TO BE  REMOVED WHEN AGGR CODE
   --  IS CLEANED UP.
   --  IT'S A REMNANT OF the spec of sem_ch5 (Franco).
   ...
   begin
      ...
      then
         ...
         --  to start with, whose components needed constraint checks.
   ...
   is
      ...
      Suggestion_1      : Entity_Id;
      Suggestion_2      : Entity_Id;
      Component_Elmt    : Elmt_Id;
