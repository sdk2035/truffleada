...
package Exp_Ch3 is
   ...
   --  discriminals. Enclos_type represents the type of the init_proc and
   --  it is used for various expansions including when Typ is a task type
   --  which is a array component, the indices of the enclosing type are
