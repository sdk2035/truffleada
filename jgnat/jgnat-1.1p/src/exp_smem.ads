...
--  See detailed documentation in System.Shared_Memory spec for a full
...
--  for generating the calls to routines in System.Shared_Memory.
...
package Exp_Smem is
   ...
   procedure Add_Shared_Memory_Locks (N : Node_Id);
   ...
   procedure Make_Shared_Mem_Procs (N : Node_Id);
   ...
   --  for the shared memory variable. See System.Shared_Memory for a full
