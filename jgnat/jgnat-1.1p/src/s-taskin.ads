...
package System.Tasking is
   ...
   --  This type should never be referenced in the run time. It is only used
   --  by restricted GNULL implementations to allocate an ATCB (see
   --  System.Task_Primitives.Operations.New_ATCB) that will take significantly
   --  less memory.
