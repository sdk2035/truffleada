         ...
         begin
            ...
            --  Else we have a FOR loop
               ...
               declare
                  ...
                  Id : constant Entity_Id := Defining_Identifier (L);
               ...
               begin
                  ...
                  if Is_Entity_Name (D)
                    and then Present (Entity (D))
                    and then Is_Type (Entity (D))
                    and then Ekind (Entity (D)) = E_Incomplete_Type
                  then
                     Set_Entity (D, Get_Full_View (Entity (D)));
                     Set_Etype  (D, Entity (D));
                  end if;
