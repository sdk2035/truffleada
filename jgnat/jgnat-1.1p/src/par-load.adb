...
procedure Load is
   ...
   Saved_Style_Checks : Style_Check_Options;
...
begin
   ...
   Save_Style_Check_Options (Saved_Style_Checks);
   ...
   --  Restore style check mode for main unit

   Set_Style_Check_Options (Saved_Style_Checks);
end Load;
