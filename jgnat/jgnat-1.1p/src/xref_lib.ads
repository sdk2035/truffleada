...
private
   ...
   Max_Dependencies : constant Positive := 400;
   --  Maximum number of dependencies that can be saved in the
   --  ALI_File structure (ie that can be found in a single .ali file)

   type Dependencies is array (1 .. Max_Dependencies)
     of Xr_Tabls.File_Reference;
