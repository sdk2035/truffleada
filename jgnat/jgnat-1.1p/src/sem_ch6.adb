...
package body Sem_Ch6 is
   ...
   begin
      ...
      if Present (Spec_Id) then
         ...
         if Is_Abstract (Spec_Id) then
            ...
            Check_Conformance
              (Body_Id, Spec_Id, Fully_Conformant, True, Conformant, Body_Id);
      ...
      while Present (E) loop
         ...
         if Scope (E) = Current_Scope then
            ...
            then
               ...
               --  two different types are given the same actual).

               if In_Instance then
                  Set_Convention (Designator, Convention (E));

                  if not Subtype_Conformant (E, Designator) then
                     goto Next_Entity;
                  end if;
               end if;
            ...
            then
               ...
               --  between body a a previous spec is an error.
   ...
   begin
      ...
      if Ekind (Formal_Id) /= E_Out_Parameter
        and then Validity_Checking = Full
      then
