...
package body Sem_Ch13 is
      ...
      case Id is
         ...
         begin
            if not Is_Discrete_Or_Fixed_Point_Type (U_Ent) then
               ...
               then
                  Error_Msg_N
                    ("Object_Size must be power of 2 or multiple of 64",
                     Expr);
               end if;
         ...
         begin
            ...
            then
               ...
               if Is_Discrete_Or_Fixed_Point_Type (U_Ent) then
                  ...
                  --  The Object_Size is set to the smallest value from
                  --  the set {8,16,32,64k, k = 1,2,3..} that is not
                  --  smaller than the size given.
   ...
   begin
      ...
      if not Esize_Known_By_Front_End (Rectype)
        and then Hbit + 1 <= 32
      then
   ...
   begin
      ...
      begin
         ...
         --  better not do this test when other errors have been
