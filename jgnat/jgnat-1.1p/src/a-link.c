...
#if defined (__osf__)
char *object_file_option = "-Wl,-input,";
...
#elif defined (sgi)
char *object_file_option = "-Wl,-objectlist,";
char *run_path_option = "-Wl,-rpath,";
int link_max = 5000;
unsigned char objlist_file_supported = 1;
...
#elif defined (hpux)
char *object_file_option = "-Wl,-c,";
char *run_path_option = "-Wl,+b,";
int link_max = 5000;
unsigned char objlist_file_supported = 1;
char shared_libgnat_default = STATIC;
unsigned char using_gnu_linker = 0;
...
unsigned char using_gnu_linker = 0;
char *object_library_extension = ".olb";

#elif defined (sun)
char *object_file_option = "";
char *run_path_option = "-R";
char shared_libgnat_default = STATIC;
int link_max = 2147483647;
unsigned char objlist_file_supported = 0;
unsigned char using_gnu_linker = 0;
