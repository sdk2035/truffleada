...
package body Lib.Xref is
   ...
   begin
      ...
      elsif not In_Extended_Main_Source_Unit (N) then
         return;
      end if;
      ...
      if Opt.Xref_Active
         ...
         --  Both entity and reference must come from source
   ...
   procedure Output_References is
      ...
      begin
         ...
         --  We take the Eun as the first unit for this purpose

         elsif T1.Lun /= T2.Lun then

            if T1.Lun = T1.Eun then
               return True;

            elsif T2.Lun = T1.Eun then
               return True;
   ...
   begin
      ...
      begin
         ...
         for Refno in 1 .. Nrefs loop
            ...
            begin
               Ctyp := Xref_Entity_Letters (Ekind (XE.Ent));
               ...
               then
                  Ctyp := Xref_Entity_Letters (Ekind (Full_View (XE.Ent)));
               end if;
               ...
               if Ctyp = '*' then
                  Ctyp :=
                    Fold_Lower
                      (Xref_Entity_Letters (Ekind (Etype (XE.Ent))));
                  ...
                  then
                     ...
                     --  Entity is access parameter, needs listing.
               ...
               then
                  ...
                  if XE.Eun /= Curxu then
                     ...
                     Write_Info_Char (' ');
                     Write_Info_Name (Unit_File_Name (XE.Eun));
                  ...
                  then
                     ...
                     Write_Info_Nat (Int (Get_Line_Number (XE.Def)));
                     ...
                     if Parent_Entry /= 0 then
                        ...
                        begin
                           ...
                           Write_Info_Nat (Int (Get_Line_Number (XD.Def)));
                           Write_Info_Char
                  ...
                  then
                     ...
                     Write_Info_Nat  (Int (Get_Line_Number (XE.Loc)));
